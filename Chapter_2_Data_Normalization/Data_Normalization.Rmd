...
# Configure conda environment for UMAP visualization
# Cross-platform setup instructions:
# 1. Create a conda environment: conda create -n UMAP_env python=3.9
# 2. Activate and install packages:
#    conda activate UMAP_env
#    pip install umap-learn pandas numpy matplotlib seaborn
# 3. Update the path below to match your conda environment location:
#    - macOS/Linux: typically ~/anaconda3/envs/UMAP_env or ~/miniconda3/envs/UMAP_env
#    - Windows: typically C:/Users/USERNAME/anaconda3/envs/UMAP_env
# You can find your conda envs path with: conda info --envs
use_condaenv(
  condaenv = 'UMAP_env',  # Use environment name; reticulate will find it automatically
  required = TRUE
)
