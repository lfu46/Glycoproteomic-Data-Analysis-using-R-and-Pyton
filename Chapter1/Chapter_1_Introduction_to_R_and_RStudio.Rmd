...
Finally, click **Download** to start the installation. ![](Chapter1_test/CRAN_R_window_download_2.png)
...
![](Chapter1_test/RStudio_download_window.png) ![](Chapter1_test/Rstudio_download_other.png)
...
![](Chapter1/Tidyverse_package.png)
...
![](Chapter1_test/readxl_package.png)
...
![](Chapter1_test/showtext_package.png)
...
![](Chapter1_test/rstatix_package.png)
...
![](Chapter1_test/ggpubr_package.png)
...
![](Chapter1_test/ComplexHeatmap_package.png)
...
![](Chapter1_test/Posit_Cheatsheets.png)
...
![](Chapter1_test/ggplot_cheatsheet_Page_1.png)
![](Chapter1_test/ggplot_cheatsheet_Page_2.png)
...
![](Chapter1_test/REDNote_example.png)
...
You can get access **training data 1** for this example using the following link: [training data 1](https://github.com/lfu46/Glycoproteomic-Data-Analysis-Tutorial-using-R-and-Python/blob/main/training_data_1.xlsx)

Here is how you would read in the data and take a quick look at it:

```{r training data 1, echo = TRUE}
#import packages
...
```{r adjusted training data 1, echo = TRUE}
