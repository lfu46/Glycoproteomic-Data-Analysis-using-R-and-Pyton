...
![](R_Basics_files/figure-gfm/training%20data%201%20heatmap-1.png)<!-- -->
...
![](R_Basics_files/figure-gfm/violin%20boxplot-1.png)<!-- -->
...
```
    ...
    ##  [4] rjson_0.2.23        xfun_0.50           GlobalOptions_0.1.2
    ##  [7] tzdb_0.4.0          Cairo_1.6-2         vctrs_0.6.5        
    ## [10] tools_4.4.0         generics_0.1.3      stats4_4.4.0       
    ## [13] parallel_4.4.0      cluster_2.1.8       pkgconfig_2.0.3    
    ## [16] RColorBrewer_1.1-3  S4Vectors_0.44.0    lifecycle_1.0.4    
    ## [19] farver_2.1.2        compiler_4.4.0      munsell_0.5.1      
    ## [22] codetools_0.2-20    carData_3.0-5       clue_0.3-66        
    ## [25] htmltools_0.5.8.1   yaml_2.3.10         Formula_1.2-5      
    ## [28] car_3.1-3           pillar_1.10.1       crayon_1.5.3       
    ## [31] iterators_1.0.14    abind_1.4-8         foreach_1.5.2      
    ## [34] tidyselect_1.2.1    digest_0.6.37       stringi_1.8.4      
    ## [37] labeling_0.4.3      fastmap_1.2.0       colorspace_2.1-1   
    ## [40] cli_3.6.4           magrittr_2.0.3      utf8_1.2.4         
    ## [43] broom_1.0.7         withr_3.0.2         backports_1.5.0    
    ## [46] scales_1.3.0        timechange_0.3.0    rmarkdown_2.29     
    ## [49] matrixStats_1.5.0   ggsignif_0.6.4      cellranger_1.1.0   
    ## [52] png_0.1-8           GetoptLong_1.0.5    hms_1.1.3          
    ## [55] evaluate_1.0.3      knitr_1.49          IRanges_2.40.1     
    ## [58] doParallel_1.0.17   rlang_1.1.5         glue_1.8.0         
    ## [61] BiocGenerics_0.52.0 rstudioapi_0.17.1   R6_2.6.1
