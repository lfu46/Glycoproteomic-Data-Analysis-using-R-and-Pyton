...
HEK_Nterm_Kd_half_life_sequence = pd.read_csv(
  'training_data/HEK_Nterm_Kd_half_life_sequence.csv',
  header = 0,
  index_col = None
)
...
common_Nterm_protein = pd.read_csv(
  'training_data/common_Nterm_protein.csv',
  header = 0,
  index_col = None
)
...
common_Nterm_alphafold_annotation = format_alphafold_data(
  directory = "/Users/longpingfu/Downloads/N_term_Probe/data_source/Nterm_degradation_structuremap/Nterm_degradation_cif",
...
common_Nterm_full_sphere_exposure = annotate_accessibility(
    ...
    max_dist = 24,
    max_angle = 180,
    error_dir = "/Users/longpingfu/Downloads/N_term_Probe/data_source/Nterm_degradation_structuremap/Nterm_degradation_pae"
)
